namespace CodexBank.Common
{
    ...
    {
        public const string ConfirmEmailSubject = "CodexBank email confirmation";

        public const string EmailConfirmationMessage =
            "To access your CodexBank account, please confirm your email by <a href=\"{0}\">clicking here</a>.";
        ...
        public const string ReceiveMoneyMessage =
            "You have received €{0}. Please log into your CodexBank account for additional information.";
