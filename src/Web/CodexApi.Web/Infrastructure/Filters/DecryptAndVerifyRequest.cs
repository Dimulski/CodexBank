...
using CodexBank.Common.Utils.Models;
using CodexApi.Services.Models.Bank;

namespace CodexApi.Web.Infrastructure.Filters
{
    public class DecryptAndVerifyRequest : ActionFilterAttribute
    {
        private CodexApiConfiguration configuration;
            ...
            ActionExecutingContext context)
        {
            ...
            var bankService = request.HttpContext.RequestServices.GetService<IBankService>();
            var configOptions = request.HttpContext.RequestServices
                .GetService<IOptions<CodexApiConfiguration>>();
